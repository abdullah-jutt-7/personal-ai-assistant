...
[Icons]
Name: "{autoprograms}\IntelliText"; Filename: "{app}\IntelliText.exe"; WorkingDir: "{app}"
Name: "{autodesktop}\IntelliText"; Filename: "{app}\IntelliText.exe"; WorkingDir: "{app}"; Tasks: desktopicon

[Run]
Filename: "{app}\IntelliText.exe"; WorkingDir: "{app}"; Description: "Launch IntelliText"; Flags: nowait postinstall skipifsilent
